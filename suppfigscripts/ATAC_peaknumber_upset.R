...
df = read.csv(paste0(input_path,'Peaklist_Final/All_Peaks_Peaklist_Final_Anno_Humreffed_exchr20.bed'),sep='\t',header=F)
peaks=unique(df$V4)
...
pdf(paste0(output_path,'Allpeaks_upset.pdf'), width=10,height=7,useDingbats=FALSE)
upset(
      df1,
      celltypes,
      queries=list(
