ATAC_All_Peaks_Down_Gnomad_Constraint_Summary_Filtered.txt contains the gnomAD constraint metrics for each
downsampled peak after removing all protein coding exons from the human gencode gtf file.
