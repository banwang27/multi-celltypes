...
#Need to change chimp_referenced_chp_hum_snps.bed to chimp_referenced_chp_hum_snps_over.bed in the +2 line from this position if liftover is uncommented.
