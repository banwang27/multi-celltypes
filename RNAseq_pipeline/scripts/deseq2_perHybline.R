...
input_path <- paste0(backup_path,'/scratch/users/banwang3/celllines/analysis/ASE_norm/',Aligned2,'/filtered/')
...
#output_path <-paste0('/scratch/users/banwang3/celllines/analysis/DESeq2_norm_splitpart/',Aligned2,'/')
...
for (cell_type in celltypes){
    for (hyb in c('Hyb1','Hyb2')){
        ...
        coldata <- data.frame(cond_line, cond_sample, cond_ChiHum)
        ...
        #print outputs
        output_filename <- paste0(output_path,cell_type,'_aligned2',Aligned2,'_qvalue_','DESeq2_',hyb,'.txt')
